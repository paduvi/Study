...
public class SplayTreeView extends JPanel {
    public final SplayTree<Integer> tree; // A binary tree to be displayed
    private final JTextField jtfKey = new JTextField(5);
    public final PaintSplayTree paintTree = new PaintSplayTree();
     ...
     */
    public SplayTreeView(SplayTree<Integer> tree) {
    ...
    public class PaintSplayTree extends JPanel {
         ...
         */
        private void displayTree(Graphics g, SplayNode<Integer> root,
